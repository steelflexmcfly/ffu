...
export class PlayoffService {
    ...
    async getPlayoffsForLeague(leagueId) {
    ...
    async getPlayoffBracket(leagueId, rosterIdToOwnerIdMap, userIdMap) {
        try {
            const bracketData = await this.sleeper.getWinnersBracket(leagueId);
    ...
    determinePlayoffPlacements(playoffBracket) {
